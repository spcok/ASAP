...
import { Animal, LogEntry, Task, ClinicalNote, MARChart, QuarantineRecord, InternalMovement, ExternalTransfer, Timesheet, Holiday, User, OrgProfileSettings, Contact, ZLADocument, MaintenanceLog, Incident, DailyRound, RolePermissionConfig, SyncQueueItem, OperationalList, Shift } from '../types';
...
export class AppDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(34).stores({
      ...
      daily_logs_v2: 'id, animal_id, log_type, log_date, created_at',
      ...
      incidents: 'id, category, date, severity',
